...
public class SensorItem {
    ...
    public SensorItem(String bitkiVeriTur, int s_bar_min, int s_bar_max, String s_bar_current, int s_bar_optimum) {
    ...
    public static ArrayList<SensorItem> getData(String [] dataLines){
        ArrayList<SensorItem> dataList = new ArrayList<SensorItem>();
